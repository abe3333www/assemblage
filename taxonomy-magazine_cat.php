...
<main id="ARTICLE">
  ...
  <section id="ARCHIVE-NEWS" class="archiveNews">
    <ul class="catList">
      <li class="cat-item <?php if (is_home() || is_post_type_archive('magazine')) echo 'current-cat'; ?> js-catItem1">
        <a href="<?php echo esc_url(home_url('magazine')); ?>">All</a>
      </li>
      <?php
    ...
    <div class="inrWidth archiveNews__wrap">
      ...
      $args = array(
        ...
        'tax_query' => array(
          array(
            'taxonomy' => 'magazine_cat',  // カテゴリのタクソノミー
